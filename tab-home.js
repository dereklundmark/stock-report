  ...
  <div style="position:relative;z-index:1;width:100%;max-width:1080px;">
    <div style="background:#0F1217;border-radius:30px;overflow:hidden;box-shadow:0 30px 70px rgba(0,0,0,.55);color:#fff;">
      ...
      <div style="padding:22px 24px 20px;">
        ...
        <div style="text-align:center;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:.14em;font-weight:800;color:#1FA0E0;margin-top:12px;">P2 LEADS · +${lead} WINS · ${T.games} GAMES LOGGED</div>
      </div>
