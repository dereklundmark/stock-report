...
const S = {
  ...
  createError: '',
  dashboards: [
    { id: 'p1-p2', name: 'P1 vs P2', p1: 'P1', p2: 'P2', p1c: '#FF5246', p2c: '#1FA0E0', games: 171 }
  ],
  activeDashboard: null,
  sessionVenue: 'online',
  sessionStep: 0,   // 0/1 = pick P1, 2 = pick P2, 3 = stats form
  currentMatch: {
    dc: '', ec: '', dcSlug: '', ecSlug: '',
    outcome: '', platform: 'Y',
    dKills: 0, eKills: 0,
...
// Match stats
function setP1Win() { S.currentMatch.outcome = 'D'; render(); }
function setP2Win() { S.currentMatch.outcome = 'E'; render(); }
