...
function renderLore() {
  ...
  const _fsLeader = (fs.ePct||0) > (fs.dPct||0) ? 'P2' : (fs.dPct||0) > (fs.ePct||0) ? 'P1' : 'Both';
  ...
  const lossRageNote = lr.eLossPct != null
    ? `Loss rage: P2 screams in ${lr.eLossPct}% of losses vs ${lr.dLossPct}% for P1.`
    : '';
  ...
  const lgNote = lg.screams
    ? `${Math.round(lg.screams/2)} screams each. E called P1 a f***ing bitch and D tried to slap him. P1 won.`
    : '';
...
<div style="max-width:1080px;margin:0 auto;padding:34px 18px 90px;">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:14px;margin-bottom:14px;">
    ...
    <div style="background:#0F1217;border-radius:14px;padding:24px;border:1px solid rgba(255,255,255,.05);">
      ...
      <div style="font-size:13px;color:#9AA3AF;margin-bottom:20px;line-height:1.5;">P1 stomps harder — but crumbles in close games.</div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:16px;">
        <div style="background:rgba(255,82,70,.05);border:1px solid rgba(255,82,70,.12);border-radius:10px;padding:16px;text-align:center;">
          ...
          <div style="display:flex;align-items:flex-end;justify-content:center;gap:14px;">
            <div>
              ...
              <div style="font-family:'JetBrains Mono',monospace;font-size:9px;color:#FF5246;margin-top:4px;">P1</div>
            </div>
            ...
            <div>
              ...
              <div style="font-family:'JetBrains Mono',monospace;font-size:9px;color:#5C6470;margin-top:4px;">P2</div>
            </div>
          </div>
        ...
        <div style="background:rgba(31,160,224,.05);border:1px solid rgba(31,160,224,.12);border-radius:10px;padding:16px;text-align:center;">
          ...
          <div style="font-weight:900;font-size:42px;line-height:1;color:#5C6470;letter-spacing:-.02em;">${cgP1Pct}%</div>
          <div style="font-family:'JetBrains Mono',monospace;font-size:9px;color:#5C6470;margin-top:4px;">P1 WIN RATE</div>
      ...
      <div style="background:rgba(255,255,255,.03);border-radius:8px;padding:12px 16px;">
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#9AA3AF;line-height:1.6;">P1 delivers near-perfect stomps <span style="color:#FF5246;font-weight:800;">${nearPerfectRatio}×</span> more than P2 — but when a game is close, he wins just <span style="color:#5C6470;font-weight:800;">${cgP1Pct}%</span> of the time. ${cgDrop} points below his average. He dominates or he crumbles. There is no middle ground.</div>
      </div>
    </div>
  </div>
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:14px;margin-bottom:14px;">
    ...
    <div style="background:#0F1217;border-radius:14px;padding:24px;border:1px solid rgba(255,255,255,.05);position:relative;overflow:hidden;">
      ...
      <div style="background:#0F1217;border:1px solid rgba(255,82,70,.12);border-radius:10px;padding:16px;margin-bottom:10px;display:flex;align-items:center;gap:14px;">
        ...
        <div style="flex:1;min-width:0;">
          ...
          <div style="font-family:'JetBrains Mono',monospace;font-size:9px;color:#5C6470;">${shirtlessD.w}W ${shirtlessD.l}L · ${shirtlessD.g}g · P2: ${shirtlessE.pct}% (${shirtlessEGapStr})</div>
        </div>
      ...
      <div style="background:#0F1217;border:1px solid rgba(255,82,70,.12);border-radius:10px;padding:16px;margin-bottom:16px;display:flex;align-items:center;gap:14px;">
        ...
        <div style="flex:1;min-width:0;">
          ...
          <div style="font-family:'JetBrains Mono',monospace;font-size:9px;color:#5C6470;">${emoD.w}W ${emoD.l}L · ${emoD.g}g · P2: ${emoE.pct}% (${emoEGapStr})</div>
        </div>
        <div style="text-align:right;flex-shrink:0;">
    ...
    <div style="background:#0F1217;border-radius:14px;padding:24px;border:1px solid rgba(255,255,255,.05);position:relative;overflow:hidden;">
      ...
      <div style="font-size:13px;color:#9AA3AF;margin-bottom:14px;line-height:1.5;">P2 likes them big. The bigger the character, the bigger the W.</div>
      ...
      <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#5C6470;line-height:1.6;">P1 also does well with these characters (${monsterD.pct}%, ${monsterD.g}g) — but P2 transforms into a different player entirely. The bigger and scarier, the better.</div>
    </div>
  </div>
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px;margin-bottom:14px;">
    ...
    <div style="background:#0F1217;border-radius:14px;padding:24px;border:1px solid rgba(255,255,255,.05);">
      ...
      <div style="font-size:13px;color:#9AA3AF;margin-bottom:16px;line-height:1.5;">P2 has played Jigglypuff <span style="color:#EDF0F3;font-weight:700;">${jp.games||0}</span> times.</div>
    ...
    <div style="background:#0F1217;border-radius:14px;padding:24px;border:1px solid rgba(255,255,255,.05);">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;">
        <div style="background:rgba(255,82,70,.08);border:2px solid rgba(255,82,70,.3);border-radius:10px;padding:14px;text-align:center;box-shadow:0 0 14px rgba(255,82,70,.1) inset;">
          <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.1em;color:#FF5246;margin-bottom:5px;">P1</div>
        ...
        <div style="background:rgba(31,160,224,.06);border:1px solid rgba(31,160,224,.16);border-radius:10px;padding:14px;text-align:center;">
          <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.1em;color:#1FA0E0;margin-bottom:5px;">P2</div>
      ...
      <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#5C6470;line-height:1.6;">P1 has played Pokémon Trainer ${ptD.g||0} times and won just ${ptD.w||0}. P2 plays the same character at ${ptE.pct||0}% — a ${ptGap}-point gap, the largest on any shared character in ${T.games} games.</div>
    </div>
  </div>
  ...
  <div style="background:#0F1217;border-radius:14px;padding:24px;margin-bottom:14px;border:1px solid rgba(255,255,255,.05);">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
      <div style="text-align:center;">
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.1em;color:#FF5246;margin-bottom:4px;">P1</div>
        <div style="font-weight:900;font-size:52px;line-height:1;color:#FF5246;letter-spacing:-.03em;">${T.dScr||0}</div>
      </div>
      <div style="text-align:center;">
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.1em;color:#1FA0E0;margin-bottom:4px;">P2</div>
    ...
    <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#5C6470;line-height:1.6;margin-bottom:22px;">P2 screams <span style="color:#1FA0E0;font-weight:800;">${screamSplit.multiplier}×</span> more — ${screamSplit.eMore} extra screams across ${T.games} games. ${lossRageNote}</div>
